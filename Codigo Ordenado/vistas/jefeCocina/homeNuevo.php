...
<head>
    ...
    <link rel="stylesheet" href="../../recursos/css/styleNuevo.css">
...
<body>
    <header id="header">
        <div class="divContenedor">
            ...
            <div class="divSubContenedorDerecha">
                ...
                <img src="../../recursos/img/logo.png" class="linkCentrado" alt="">
            </div>
        </div>
    </header>
    ...
    <section class="contenedorDietas" id="opcionesDieta">
        ...
        <article class="subContenedorDatos">
            <form action="../registros/registrarDieta.php" method="post" enctype="multipart/form-data" class="formDieta">
    ...
    <section class="contenedorPlatos" id="opcionesPlato">
        ...
        <form action="../registros/registrarPlato.php" method="post" enctype="multipart/form-data">
    ...
    <section class="contenedorMenus" id="opcionesMenu">
        ...
        <form action="../registros/registrarMenu.php" method="post" enctype="multipart/form-data">
