...
<head>
    ...
    <link rel="stylesheet" href="../../recursos/css/jefeCocina/styleHomeMenus.css">
...
<body>
    ...
    <section class="contenedorMenus contenedorMenus5" id="opciones5">
        ...
        <form action="../../datos/registrarMenuUsuario.php" method="post" enctype="multipart/form-data">
            ...
            <article class="subContenedorInternoDatosMenu">
                ...
                <div class="divDatosMenu">
                    ...
                    <br>
                    <textarea name="descripcion" id="" cols="20" rows="5"></textarea>
                    <br><br>
                </div>
            </article>
    ...
    <section class="contenedorMenus contenedorMenus10" id="opciones10">
        ...
        <form action="../../datos/registrarMenuUsuario.php" method="post" enctype="multipart/form-data">
            ...
            <article class="subContenedorInferiorDatosMenu">
                <div class="divDatosMenu">
                    <button class="botonEnviarMenu" type="submit" name="boton10" value="5">Enviar</button>
                </div>
            </article>
        </form>
    </section>
        ...
        <form action="../../datos/registrarMenuUsuario.php" method="post" enctype="multipart/form-data">
            <article class="subContenedorSuperiorDatosMenu">
                <div class="divDatosMenuNombre">
                    <label for="Mdiet">Nombre:</label>
                    <br>
                    <input type="text" name="nombreMenu" id="Mdiet" placeholder="Menu..." required>
                </div>
            </article>
            <article class="subContenedorInternoDatosMenu">
                <div class="divDatosMenu">
            ...
            <article class="subContenedorInferiorDatosMenu">
                <div class="divDatosMenu">
                    <button class="botonEnviarMenu" type="submit" name="boton20" value="5">Enviar</button>
                </div>
            </article>
        </form>
    </section>
