        ...
        for( $z = 0 ; $z < $cantidad0 ; $z++){
            ...
            if ($i == 1) {
                ...
                echo "                  </div>";
                    ...
                    if($stockReal > $stockPiso) {
                        echo "<button type='submit' name='btnEstado' value='1'>Preparar Pedido</button>";
                        echo "<button type='submit' name='btnEstado' value='7'>Rechazar Pedido</button>";
                        
                    } else if( $stockReal == 0 && $stockPiso == 0) {
                        echo "<button type='submit' name='btnEstado' value='Personalizado'>Preparar Pedido Personalizado</button>";
                        echo "<button type='submit' name='btnEstado' value='7'>Rechazar Pedido</button>";

                    } else if( $stockPiso == $stockReal) {
                        echo "<a href='homeAlertas.php'>⚠Sin Stock⚠</a>";
                        echo "<button type='submit' name='btnEstado' value='7'>Rechazar</button>";

                    } else if( $stockReal < $stockPiso) {
                        echo "<a href='homeAlertas.php'>⚠Sin Stock⚠</a>";
                        echo "<button type='submit' name='btnEstado' value='7'>Rechazar</button>";
                    }
                echo "              </div>";
                ...
                echo "                  </div>";
                                        ...
                                        if($stockReal > $stockPiso) {
                                            echo "<button type='submit' name='btnEstado' value='1'>Empezar a producir</button>";
                                            echo "<button type='submit' name='btnEstado' value='7'>Rechazar</button>";
                                        } else if( $stockReal == 0 && $stockPiso == 0) {
                                            echo "<button type='submit' name='btnEstado' value='Personalizado'>Preparar Pedido Personalizado</button>";
                                            echo "<button type='submit' name='btnEstado' value='7'>Rechazar</button>";
                                        } else if( $stockPiso == $stockReal) {
                                            echo "<a href='homeAlertas.php'>⚠Stock Piso⚠</a>";
                                            echo "<button type='submit' name='btnEstado' value='7'>Rechazar</button>";
                                        } else if( $stockReal < $stockPiso) {
                                            echo "<a href='homeAlertas.php'>⚠Sin Stock⚠</a>";
                                            echo "<button type='submit' name='btnEstado' value='7'>Rechazar</button>";
        ...
        for( $z = 0 ; $z < $cantidad1 ; $z++){
            ...
            if ($i == 1) {
                ...
                echo "                  </div>";
                    ...
                    echo "<button type='submit' name='btnEstado' value='2'>Finalizar Preparación</button>";
                    echo "<button type='submit' name='btnEstado' value='3'>Cancelar Pedido</button>";
                echo "              </div>";
                echo "              <div class='subComboMenus'>";
                echo "                   <h2>$nombreMenu</h2>";
                echo "                   <img src='../../recursos/img/greenSquare.png' alt=''>";
            ...
            for( $z = 0 ; $z < $cantidad2 ; $z++){
                ...
                if ($i == 1) {
                    ...
                    echo "                  </div>";
                        echo "<input type='hidden' name='idmenu' value='$idMenu'>";
                        echo "<input type='hidden' name='idpedido' value='$idPedido'>";
                        echo "<button type='submit' name='btnEstado' value='4'>Enviar Pedido</button>";
                        echo "<button type='submit' name='btnEstado' value='3'>Cancelar Pedido</button>";
        ...
        for( $z = 0 ; $z < $cantidad3 ; $z++){
            ...
            if ($i == 1) {
                ...
                echo "                  </div>";
                                        ...
                                        if ($cantidadFilas > 3 && $stockTecho == 0 && $idEstadoCajaMenu == 0) {
                                            echo "<button type='submit' name='btnEstado' value='22'>Desechar</button>";
                                        } else if ($cantidadFilas > 3 && $stockTecho == 0 && $idEstadoCajaMenu == 2) {
                                            echo "<button type='text'>Pedido Desechado</button>";
                                        } else if($cantidadFilas > 3 && $idEstadoCajaMenu == 0 && $stockTecho != 0) {
                                            echo "<p>Cómo se procederá con la Caja del Menú envasada?</p>";
                                            echo "<button type='submit' name='btnEstado' value='21'>Recuperar</button>";
                                            echo "<button type='submit' name='btnEstado' value='22'>Desechar</button>";
                                        } else if($cantidadFilas > 3 && $idEstadoCajaMenu == 1 && $stockTecho != 0){
                                            echo "<button type='text'>Se Recuperó la Caja asignada</button>";
                                        } else if($cantidadFilas > 3 && $idEstadoCajaMenu == 2 && $stockTecho != 0){
                                            echo "<button type='text'>Se Desechó la Caja asignada</button>";
                                        } else {
                                            echo "<button type='submit'>Pedido Desechado</button>";
                                        }
        ...
        for( $z = 0 ; $z < $cantidad4 ; $z++){
            ...
            if ($i == 1) {
                ...
                echo "                  </div>";
                    ...
                    echo "<input type='hidden' name='stocktecho' value='$stockTecho'>";
                    echo "<input type='hidden' name='idcajamenu' value='$idCajaMenu'>";
                    echo "<button type='submit' name='btnEstado' value='5'>Finalizar Pedido - Entregado</button>";
                    echo "<button type='submit' name='btnEstado' value='6'>Finalizar Pedido - Devuelto</button>";
                echo "              </div>";
                echo "              <div class='subComboMenus'>";
                echo "                   <h2>$nombreMenu</h2>";
                echo "                   <img src='../../recursos/img/greenSquare.png' alt=''>";
        ...
        for( $z = 0 ; $z < $cantidad5 ; $z++){
            ...
            if ($i == 1) {
                ...
                echo "                  </div>";
                    ...
                    echo "<button type='submit'>Pedido Entregado</button>";
        ...
        for( $z = 0 ; $z < $cantidad6 ; $z++){
            ...
            if ($i == 1) {
                ...
                echo "                  </div>";
                    ...
                    if ($idEstadoCajaMenu == "1") {
                        echo "<button type='text'>Caja Devuelta</button>";
                    } else if ($idEstadoCajaMenu == "2") {
                        echo "<button type='text'>Caja Desechada</button>";
                    } else if ($idEstadoCajaMenu == "3" && $stockTecho != 0) {
                        echo "<button type='submit' name='btnEstado' value='21'>Recuperar Caja Asignada</button>";
                        echo "<button type='submit' name='btnEstado' value='22'>Desechar Caja Asignada</button>";
                    } else if ($idEstadoCajaMenu == "3" && $stockTecho == 0) {
                        echo "<button type='submit' name='btnEstado' value='22'>Desechar Caja Asignada</button>";
                    }
