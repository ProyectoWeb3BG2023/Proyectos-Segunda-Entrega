...
if ($_POST && $_POST['tipoDocumentoCl'] == "RUT") {
    ...
    $tipoDocumento = $_POST['tipoDocumentoCl'];
    ...
    $cambioDatosUsuario = "UPDATE cliente
                           SET primer_nombre='$primernombre', email='$mail', calle='$calle', numero_puerta='$puerta', esquina='$esquina' 
